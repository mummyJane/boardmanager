...
function renderTextTable(rows, columns) {
  ...
  for (const column of columns) {
    widths[column.key] = column.label.length;
  }
...
async function main() {
  ...
  if (args.view === "units") {
    console.log(renderTextTable(payload, [
